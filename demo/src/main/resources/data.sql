...
(CONCAT(CURDATE(), ' 11:58:10'), 'PM003', 2, 1850, 'MAINT001'),
...
(CONCAT(CURDATE(), ' 13:35:10'), 'PM001', 2, 2280, 'MAINT001'),
...
(CONCAT(CURDATE(), ' 14:57:15'), 'PM005', 2, 2690, 'MAINT001'),
(CONCAT(CURDATE(), ' 15:15:31'), 'PM002', 2, 2810, 'MAINT001'),
(CONCAT(CURDATE(), ' 15:30:44'), 'PM007', 1, 2900, NULL),
(CONCAT(CURDATE(), ' 15:48:55'), 'PM001', 1, 3050, NULL),
(CONCAT(CURDATE(), ' 16:05:07'), 'PM004', 2, 3180, 'MAINT001'),
